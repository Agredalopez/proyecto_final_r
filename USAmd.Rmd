...
'# Finalmente se anexa información de las estaciones de la ciudad de los Ángeles, California, obtenida de la API [CityBik](http://api.citybik.es/).
...
```{r q, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center',fig.width=8, fig.height=4}
